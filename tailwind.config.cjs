...
// clona STANDALONE en CI (sin el monorepo), y el paquete @coongro/tailwind-config
// es privado (no publicado). Mantener en sync con packages/tailwind-config si
// cambian los tokens. preflight:false evita duplicar el reset del host.
const cg = {
